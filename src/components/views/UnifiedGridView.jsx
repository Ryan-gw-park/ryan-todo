                ...
                <DroppableCell key={dropId} id={dropId} activeId={activeId}>
                  <div style={{ padding: '6px 8px', minHeight: 36 }}>
                    {isCol ? (
                      ...
                      <>
                        <MsGroupedTasks tasks={cellTasks} cellMilestones={milestones.filter(m => m.project_id === proj.id && m.owner_id === userId)} editingId={editingId} setEditingId={setEditingId} handleEditFinish={handleEditFinish} toggleDone={toggleDone} openDetail={openDetail} />
              ...
              return (
                <DroppableCell key={dropId} id={dropId} activeId={activeId}>
                  <div style={{
                    ...
                    <MsGroupedTasks tasks={dayTasks} cellMilestones={milestones.filter(m => m.project_id === proj.id && m.owner_id === userId)} editingId={editingId} setEditingId={setEditingId} handleEditFinish={handleEditFinish} toggleDone={toggleDone} openDetail={openDetail} />
